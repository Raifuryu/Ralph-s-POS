...
export default async function Home({
  ...
  try {
    [
      ...
      baselineFundTargetRows,
        ...
        // The owner-maintained target VaultCard's "Baseline Fund" gap note
        // (and its "Set target" trigger) is measured against — see
        // setBaselineFundTarget's own comment in
        // lib/mysql/operations/storeSettings.ts. No row yet reads the same
        // as "no target set" (baselineFundTargetRows[0]?.baseline_fund_target
  ...
  // The owner-maintained target VaultCard's headline gap note is measured
